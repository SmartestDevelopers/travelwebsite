...
<section class="dashboard-area">
      ...
      <div class="dashboard-content-wrap">
        ...
        <tbody>
    @forelse($toursearchlists as $toursearchlist)
    <tr>
        <td>{{ $toursearchlist->id }}</td>
        <td>{{ $toursearchlist->destination }}</td>
        <td>{{ $toursearchlist->start_date }}</td>
        <td>{{ $toursearchlist->end_date }}</td>
        <td>{{ $toursearchlist->adult_number }}</td>
        <td>{{ $toursearchlist->child_number }}</td>
        <td>{{ $toursearchlist->price }}</td>
    </tr>
    @empty
    <tr>
