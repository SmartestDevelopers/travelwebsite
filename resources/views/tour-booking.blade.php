                        ...
                        <div class="input-box">
                          <div class="custom-checkbox mb-0">
                            ...
                            <label for="receiveChb"
                              >I want to receive Trizen's promotional offers in
                              the future</label
                            >
                          </div>
                        </div>
                ...
                <div class="section-tab check-mark-tab text-center pb-4">
                  ...
                  >
                    ...
                    <li class="nav-item">
                      ...
                      >
                        <i class="la la-check icon-element"></i>
                        <img src="{{asset('travel-website/images/payoneer.png" alt="" />
                    ...
                    <ul class="list-items list-items-2 list-items-flush py-2">
                      <li class="font-size-15">
                        <span class="w-auto d-block mb-n1"
                          ><i
                            class="la la-calendar me-1 text-black font-size-17"
                          ></i
                          >Check in</span
                        >12 May 2020 7:40am
                      </li>
                      ...
                      <li class="font-size-15">
                        <span class="w-auto d-block mb-n1"
                          ><i
                            class="la la-clock-o me-1 text-black font-size-17"
                          ></i
                          >Duration</span
                        >3 days 3 hours
                      </li>
                      <li class="font-size-15">
                        <span class="w-auto d-block mb-n1"
                          ><i
                            class="la la-map-marker me-1 text-black font-size-17"
                          ></i
                          >Location</span
