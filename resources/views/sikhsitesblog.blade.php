        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="section-heading margin-bottom-40px">
              <h2 class="sec__title">Top Sikh Religious Sites in Pakistan: Pilgrimage Destinations for Devotees</h2>
              <h4 class="title font-size-16 line-height-26 pt-4 pb-2">
               <strong>Pakistan is home to some of the most sacred Sikh religious sites, making it a significant destination for Sikh devotees worldwide. These sites not only hold immense spiritual value but also reflect the rich history and culture of Sikhism</strong>
              </h4>
              <p class="sec__desc font-size-16 pb-3"><strong>1. Gurdwara Janam Asthan (Nankana Sahib):</strong> The birthplace of Guru Nanak Dev Ji, this site is one of the holiest places for Sikhs. Located in Nankana Sahib, it attracts thousands of pilgrims annually.</p>
              <p class="sec__desc font-size-16 pb-3">
              <strong>2. Gurdwara Darbar Sahib (Kartarpur):</strong>Known as the final resting place of Guru Nanak Dev Ji, this Gurdwara symbolizes peace and interfaith harmony. The Kartarpur Corridor has made it easily accessible for pilgrims.
              </p>
              <p class="sec__desc font-size-16">
              <strong>3. Gurdwara Panja Sahib (Hassan Abdal):</strong> Famous for the handprint of Guru Nanak Dev Ji on a rock, this site is a spiritual haven surrounded by scenic beauty.
              </p>
              <p class="sec__desc font-size-16">These sacred sites offer a profound spiritual experience and a chance to connect with Sikh heritage, making Pakistan a must-visit destination for Sikh pilgrims.</p>
            </div>
            <!-- end section-heading -->
          </div>
          <!-- end col-lg-6 -->
          <div class="col-lg-5 ms-auto">
            <div class="image-box about-img-box">
              ...
              />
              <img
                src="{{ asset('travel-website/images/gurdwara.jpg')}}"
                alt="about-img"
