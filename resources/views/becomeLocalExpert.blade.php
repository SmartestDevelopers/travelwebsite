              ...
              <div class="breadcrumb-content">
                <div class="section-heading">
                  <h2 class="sec__title line-height-55 text-white">
                    Let's Show the Beauty of Your <br />
                    City to the World
                  </h2>
                  <p class="sec__desc pt-2 text-white">
                    Join 3000+ locals & 1400+ contributors from 2000 cities
                  </p>
                </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="section-heading text-center">
              <h2 class="sec__title">How Trizen work?</h2>
            </div>
            <!-- end section-heading -->
          </div>
          <!-- end col-lg-12 -->
...
================================= -->
    <section
      class="info-area section-bg padding-top-200px padding-bottom-100px text-center"
    >
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
        ...
        <div class="row padding-top-60px">
          ...
          <div class="col-lg-4 responsive-column">
            <div class="icon-box">
              ...
              <!-- end info-icon-->
              <div class="info-content">
                <h4 class="info__title line-height-26">
