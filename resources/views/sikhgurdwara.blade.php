        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="section-heading margin-bottom-40px">
              <h2 class="sec__title">Top Gurdwaras in Pakistan: A Spiritual Journey Through Sikh Heritage</h2>
              <h4 class="title font-size-16 line-height-26 pt-4 pb-2">
              Pakistan is home to some of the most significant Gurdwaras in Sikh history, offering a profound spiritual journey for devotees and history enthusiasts alike. These sacred sites not only hold immense religious importance but also reflect the rich cultural and architectural heritage of the Sikh community.
              </h4>
               <p class="sec__desc font-size-16 pb-3"><strong>1. Gurdwara Janam Asthan (Nankana Sahib):</strong> Located in Nankana Sahib, this Gurdwara marks the birthplace of Guru Nanak Dev Ji, the founder of Sikhism. It is one of the holiest sites for Sikhs worldwide. The serene atmosphere and grand architecture make it a must-visit destination for spiritual seekers.</p>
              <p class="sec__desc font-size-16 pb-3">
              <strong>2. Gurdwara Darbar Sahib (Kartarpur):</strong>Situated in Kartarpur, this Gurdwara is where Guru Nanak Dev Ji spent the last years of his life. Known for its peaceful surroundings and historical significance, it has become a symbol of interfaith harmony. The Kartarpur Corridor allows easy access for Sikh pilgrims from India.
              </p>
              <p class="sec__desc font-size-16">
              <strong>3. Gurdwara Panja Sahib (Hassan Abdal):</strong> This sacred site in Hassan Abdal is famous for the imprint of Guru Nanak Dev Ji's hand on a rock. It is a place of immense spiritual significance and attracts thousands of pilgrims every year. The Gurdwara is surrounded by picturesque hills, adding to its charm.
              </p>
              <br>
              <p class="sec_desc font-size-16">
              These Gurdwaras are not just places of worship but also symbols of peace and unity, welcoming visitors from around the world to experience their spiritual and cultural richness.</p>
          ...
          <div class="col-lg-5 ms-auto">
            <div class="image-box about-img-box">
              ...
              />
              <img
                src="{{ asset('travel-website/images/sikh1.jpg')}}"
                alt="about-img"
