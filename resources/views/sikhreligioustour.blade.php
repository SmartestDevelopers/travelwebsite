                ...
                <div id="description" class="page-scroll">
                  <div class="single-content-item pb-4">
                    <h3 class="title font-size-26">
                      8 Days Sikh Religious Tour
                    </h3>
                    <div class="d-flex flex-wrap align-items-center pt-2">
                      <p class="me-2">Lahore, Peshawar, Hasan Abdal, Taxila, Pakistan</p>
                      <p>
                        <span
                      ...
                      <div class="col-lg-4 responsive-column">
                        ...
                        >
                          ...
                          <div class="single-feature-titles">
                            ...
                            <span class="font-size-13">8 Days 7 Nights</span>
                          </div>
                        </div>
                    ...
                    <div class="comments-list padding-top-50px">
                      <div class="comment">
                        ...
                        <div class="comment-body">
                          <div class="meta-data">
                            <h3 class="comment__author">Gaurav Singh</h3>
                            <div class="meta-data-inner d-flex">
                              ...
                              <p class="comment__date">February 6, 2025</p>
                            </div>
                          </div>
                          <p class="comment-content">
                          The Sikh tour was a life-changing experience. Visiting the sacred Gurdwaras and learning about their history was truly enlightening. The Kartarpur Corridor visit was well-organized, and the team made sure everything went smoothly. Highly recommended!
                          </p>
                          <div
                      ...
                      <div class="comment comment-reply-item">
                        ...
                        <div class="comment-body">
                          <div class="meta-data">
                            <h3 class="comment__author">Ponam Kaur</h3>
                            <div class="meta-data-inner d-flex">
                              <span
                                class="ratings d-flex align-items-center me-1"
                              >
                              ...
                              <p class="comment__date">March 13, 2025</p>
                            </div>
                          </div>
                          <p class="comment-content">
                          The Sikh tour was an incredible spiritual journey! Visiting Gurdwara Janam Asthan and Kartarpur Sahib was deeply moving. The guides were knowledgeable, and the arrangements were seamless. I felt a strong connection to my roots. Highly recommended for anyone seeking a meaningful experience!
                          </p>
                          <div
                            class="comment-reply d-flex align-items-center justify-content-between"
                          >
                      ...
                      <div class="comment">
                        ...
                        <div class="comment-body">
                          <div class="meta-data">
                            <h3 class="comment__author">Harpreet</h3>
                            <div class="meta-data-inner d-flex">
                              <span
                                class="ratings d-flex align-items-center me-1"
                              >
                              ...
                              <p class="comment__date">April 12, 2025</p>
                            </div>
                          </div>
                          <p class="comment-content">
                          This tour was beyond my expectations! The spiritual energy at Gurdwara Panja Sahib and the peaceful surroundings of Kartarpur Sahib were unforgettable. The guides were friendly and knowledgeable, making the experience even more special."
                          </p>
                          <div
                            class="comment-reply d-flex align-items-center justify-content-between"
                          >
